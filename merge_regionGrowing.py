# -*- coding: utf-8 -*-
"""
Created on Wed Sep 13 14:30:09 2017
...
def merge_rg(labels, rag, seeds, thresh, rag_copy, in_place_merge,
    ...
    in_place_merge = True # has to be True for correct seed tracking
